...
1. User selects a book → receives map directions → goes to shelf → checks out.

2. User gets the app notification → checks the expiring borrowed books on app or online → returns the book and reduces the frustration of missing the due date.
