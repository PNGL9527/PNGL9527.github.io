...
<div class="not-prose mt-12 flex flex-col items-center gap-4 text-center">
    <a
      href={`${import.meta.env.BASE_URL}assets/projects/cdc/cdc_blueprint.pdf`}
      target="_blank"
      rel="noopener noreferrer"
      class="case-btn inline-flex items-center justify-center rounded-full !px-5 !py-3 !leading-none"
>
    >
